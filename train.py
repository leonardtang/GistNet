...
def train(add, num_testing, object_dim, job_name, **kwargs):
    coco_train = COCO('/home/leonard/../../media/data/Datasets/MSCOCO2014/annotations/instances_train2014.json')
    coco_test = COCO('/home/leonard/../../media/data/Datasets/MSCOCO2014/annotations/instances_val2014.json')
    ...
    callbacks_list = [
        ModelCheckpoint('../model_weights/' + job_name + '.h5', monitor='val_loss', verbose=1, save_best_only=True,
                        mode='min')]
